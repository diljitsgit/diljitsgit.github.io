export default function About() {
  return (
    <section className=" border-darkOutline border-b scroll-m-20" id="about">
        ...
        <div className="flex flex-col justify-between items-center text-center text-white mx-auto gap-4">
          ...
          <div className="font-mono text-md flex flex-col-reverse md:flex-row gap-12 justify-between items-center text-left">
            <p className="text-justify md:text-left">
              Hey! I'm Diljit, a design enthusiast who became a frontend
              developer. I've explored visuals, editing, and 3D projects.
              Eventually, I shifted my focus to creating functional web
              experiences.
              <br />
              <br /> Now, I concentrate on clean, interactive interfaces with
              some personality. I enjoy learning, no matter the challenge. I
              often break things just to improve them, and I'm always trying to
              pick up new tools or methods.
              <br />
              <br /> Whether my work is creative or technical, even a little
              messy, I'm open to trying it all.
            </p>
            <img
              src="/favicon.svg"
